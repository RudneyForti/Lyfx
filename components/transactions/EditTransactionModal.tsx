...
import { IconX, IconCheck, IconCurrencyReal, IconRepeat, IconRepeatOff } from "@tabler/icons-react";
    ...
    >
      <div className="bg-[var(--color-bg2)] border border-[var(--color-border2)] rounded-[18px] w-full max-w-[480px] overflow-hidden shadow-[0_24px_48px_rgba(0,0,0,0.6)] mx-4 max-h-[92vh] flex flex-col">
        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-[var(--color-border)] flex-shrink-0">
          <span className="text-[15px] font-semibold text-[var(--color-f1)]">Editar transação</span>
          <button
            onClick={onClose}
